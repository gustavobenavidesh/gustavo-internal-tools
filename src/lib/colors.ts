...
> = {
  none: {
    ...
    bar: "bg-transparent",
    chip: "text-ink-faint",
    pill: "bg-black/5 text-ink-faint ring-black/5",
  },
  low: {
    label: "Low",
    bar: "bg-sky-600/60",
    chip: "text-sky-800",
    pill: "bg-sky-600/10 text-sky-800 ring-sky-700/20",
  },
  medium: {
    label: "Medium",
    bar: "bg-amber-500/80",
    chip: "text-amber-800",
    pill: "bg-amber-500/18 text-amber-800 ring-amber-700/20",
  },
  ...
  high: {
    ...
    bar: "bg-rose-600",
    chip: "text-rose-800",
    pill: "bg-rose-600/14 text-rose-900 ring-rose-700/25",
  },
};
